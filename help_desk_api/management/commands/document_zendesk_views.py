...
from help_desk_api.utils import ZendeskViews
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        views = ZendeskViews(views, zendesk_config)
        context = views.document()
        template: Template = get_template("views.html")
