...
from help_desk_api.utils.triggers import ZendeskAutomations
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        with open(options["input"], "r") as input_file:
            automations = json.load(input_file)
        ...
        automations = ZendeskAutomations(automations, zendesk_config)
        context = automations.document()
        template: Template = get_template("automations.html")
