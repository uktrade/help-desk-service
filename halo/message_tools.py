...
from help_desk_api.urls import urlpatterns
...
def message_issue_halo_url(slack_client, halo_uri, ticket_id, chat_id, channel_id):
    """Post to slack where the Halo URL of the issue."""
    url = urlpatterns(halo_uri, ticket_id)
